...
export default function PeluangPage3() {
  return (
    <div className="bg-slate-900 text-white min-h-screen p-8">
      <Head>
        <title>Peluang: Video Pembahasan | Bagian 3</title>
      </Head>
      <div className="container mx-auto px-6 py-12">
        ...
        <div className="aspect-w-16 aspect-h-9 mb-8">
         <iframe
            ...
            title="Pembahasan materi PELUANG"
            frameBorder="0"
        ...
        <div className="flex justify-between mt-12 pt-8 border-t border-slate-700">
          ...
          <Link href="/materi/math/11" className="text-blue-400 hover:text-blue-500 transition-colors flex items-center">
            Kembali ke Daftar Materi Peluang
          </Link>
        </div>
      </div>
    </div>
