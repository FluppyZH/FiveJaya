...
export default function MateriKelas11Index() {
  const pages = [
    {
      title: "Pengenalan dan Sifat-sifat",
      description: "Memahami konsep dasar Peluang dan sifat-sifatnya dalam fungsi.",
      href: "/materi/math/11/page-1"
    },
    {
      title: "Definisi, Rumus, dan Contoh",
      description: "Mempelajari berbagai teknik untuk menyelesaikan soal Peluang.",
      href: "/materi/math/11/page-2"
    },
    {
      title: "Video Pembahasan",
      description: "Melihat pembahasan materi dengan melalui video.",
      href: "/materi/math/11/page-3"
    },
  ];
  ...
  return (
    <div className="bg-slate-900 text-white min-h-screen p-8">
      <Head>
        <title>Materi Peluang Kelas 11 | E-LearnQU</title>
      </Head>
