...
export default function MateriKelas12Index() {
  const pages = [
    ...
    },
    {
      ...
      description: "Mempelajari perbedaan dan penggunaan permutasi serta kombinasi.",
      href: "/materi/math/12/page-2"
    },
    {
      title: "Kejadian Majemuk dan Harapan",
      description: "Menganalisis Limit kejadian majemuk dan nilai harapan.",
  ...
  return (
    <div className="bg-slate-900 text-white min-h-screen p-8">
      <Head>
        <title>Materi Limit Kelas 12 | E-LearnQU</title>
      </Head>
